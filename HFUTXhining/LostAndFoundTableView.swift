//
//  LostAndFoundTableView.swift
//  HFUTXhining
//
//  Created by   chironyf on 19/09/2017.
...
class LostAndFoundTableView: BaseTableView {
  
    var currentPostArray: Array<LostAndFoundPostReceivedModel> = []
    ...
    override func addUpdateAndMore() -> Void {
        ...
        self.es_addPullToRefresh {
            ...
            Alamofire.request(READ_POST_URL, method: .post, parameters: parameters).responseJSON {
                ...
                var receviedData: Array<LostAndFoundPostReceivedModel> = []
                lostAndFoundJsonAssignArray(&receviedData, json)
